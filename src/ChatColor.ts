...
export default class ChatColor {
     ...
     * Black color code. (0)
     */
    public static readonly BLACK: ChatColor = /* @__PURE__ */ new ChatColor(
        '0',
        0x000000
    );
    /**
     ...
     */
    public static readonly DARK_BLUE: ChatColor = /* @__PURE__ */ new ChatColor(
        '1',
        0x0000aa
    );
    /**
     ...
     */
    public static readonly DARK_GREEN: ChatColor =
        /* @__PURE__ */ new ChatColor('2', 0x00aa00);
    /**
     * Dark aqua color code. (3)
     */
    public static readonly DARK_AQUA: ChatColor = /* @__PURE__ */ new ChatColor(
        '3',
        0x00aaaa
    );
    /**
     ...
     */
    public static readonly DARK_RED: ChatColor = /* @__PURE__ */ new ChatColor(
        '4',
        0xaa0000
    );
    /**
     ...
     */
    public static readonly DARK_PURPLE: ChatColor =
        /* @__PURE__ */ new ChatColor('5', 0xaa00aa);
    /**
     * Gold color code. (6)
     */
    public static readonly GOLD: ChatColor = /* @__PURE__ */ new ChatColor(
        '6',
        0xffaa00
    );
    /**
     * Gray color code. (7)
     */
    public static readonly GRAY: ChatColor = /* @__PURE__ */ new ChatColor(
        '7',
        0xaaaaaa
    );
    /**
     ...
     */
    public static readonly DARK_GRAY: ChatColor = /* @__PURE__ */ new ChatColor(
        '8',
        0x555555
    );
    /**
     * Blue color code. (9)
     */
    public static readonly BLUE: ChatColor = /* @__PURE__ */ new ChatColor(
        '9',
        0x5555ff
    );
    /**
     * Green color code. (a)
     */
    public static readonly GREEN: ChatColor = /* @__PURE__ */ new ChatColor(
        'a',
        0x55ff55
    );
    /**
     * Aqua color code. (b)
     */
    public static readonly AQUA: ChatColor = /* @__PURE__ */ new ChatColor(
        'b',
        0x55ffff
    );
    /**
     * Red color code. (c)
     */
    public static readonly RED: ChatColor = /* @__PURE__ */ new ChatColor(
        'c',
        0xff5555
    );
    /**
     ...
     */
    public static readonly LIGHT_PURPLE: ChatColor =
        /* @__PURE__ */ new ChatColor('d', 0xff55ff);
    /**
     * Yellow color code. (e)
     */
    public static readonly YELLOW: ChatColor = /* @__PURE__ */ new ChatColor(
        'e',
        0xffff55
    );
    /**
     * White color code. (f)
     */
    public static readonly WHITE: ChatColor = /* @__PURE__ */ new ChatColor(
        'f',
        0xffffff
    );
    /**
     ...
     */
    public static readonly MINECOIN_GOLD: ChatColor =
        /* @__PURE__ */ new ChatColor('g', 0xded605);
    /**
     * Material quartz color code. (h)
     */
    public static readonly MATERIAL_QUARTZ: ChatColor =
        /* @__PURE__ */ new ChatColor('h', 0xe3d4d1);
    /**
     * Material iron color code. (i)
     */
    public static readonly MATERIAL_IRON: ChatColor =
        /* @__PURE__ */ new ChatColor('i', 0xcecaca);
    /**
     * Material netherite color code. (j)
     */
    public static readonly MATERIAL_NETHERITE: ChatColor =
        /* @__PURE__ */ new ChatColor('j', 0x443a3b);
    /**
     * Material redstone color code. (m)
     */
    public static readonly MATERIAL_REDSTONE: ChatColor =
        /* @__PURE__ */ new ChatColor('m', 0x971607);
    /**
     * Material copper color code. (n)
     */
    public static readonly MATERIAL_COPPER: ChatColor =
        /* @__PURE__ */ new ChatColor('n', 0xb4684d);
    /**
     * Material gold color code. (p)
     */
    public static readonly MATERIAL_GOLD: ChatColor =
        /* @__PURE__ */ new ChatColor('p', 0xdeb12d);
    /**
     * Material emerald color code. (q)
     */
    public static readonly MATERIAL_EMERALD: ChatColor =
        /* @__PURE__ */ new ChatColor('q', 0x11a036);
    /**
     * Material diamond color code. (s)
     */
    public static readonly MATERIAL_DIAMOND: ChatColor =
        /* @__PURE__ */ new ChatColor('s', 0x2cbaa8);
    /**
     * Material lapis color code. (t)
     */
    public static readonly MATERIAL_LAPIS: ChatColor =
        /* @__PURE__ */ new ChatColor('t', 0x21497b);
    /**
     * Material amethyst color code. (u)
     */
    public static readonly MATERIAL_AMETHYST: ChatColor =
        /* @__PURE__ */ new ChatColor('u', 0x9a5cc6);
    /**
     * Obfuscated color code. (k)
     */
    public static readonly OBFUSCATED: ChatColor =
        /* @__PURE__ */ new ChatColor('k');
    /**
     * Bold color code. (l)
     */
    public static readonly BOLD: ChatColor = /* @__PURE__ */ new ChatColor('l');
    /**
     * Italic color code. (o)
     */
    public static readonly ITALIC: ChatColor = /* @__PURE__ */ new ChatColor(
        'o'
    );
    /**
     * Reset color code. (r)
     */
    public static readonly RESET: ChatColor = /* @__PURE__ */ new ChatColor(
        'r'
    );
